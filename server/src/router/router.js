...
const { registerController, loginController, getUserInfo, refreshTokenController } = require("../controllers/user/user");
...
router.get("/user/refreshToken", refreshTokenController)
